...
export interface IUserRepository {
  ...
  update(id: string, data: Partial<{ username: string; email: string; locale: string; timezone: string; avatar: string | null; telegramBotToken: string | null; telegramChatId: string | null; telegramNotificationsEnabled: boolean }>): Promise<User | null>;
